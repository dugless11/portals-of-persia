...
func _ready() -> void:
	...
	moveObject($Camera2D, $Camera2D.transform, Transform2D($Camera2D.rotation_degrees, Vector2(576, 324 + 100.0)), 2, 3, "lerp", $Camera2D.position, $Camera2D.position)
	moveObject($Camera2D, $Camera2D.transform, Transform2D($Camera2D.rotation_degrees, Vector2(576, 324 + 100.0)), 3, 4, "shake", Vector2(576, 324 + 100.0), $Camera2D.position)
...
func _process(delta: float) -> void:
	...
	if(cutsceneTimer >= 4):
		$Icon.rotate(3 * (cutsceneTimer - 3)/38)
		if(cutsceneTimer < 6):
